...
Project completed on July 14, 2026.

Verified:

- Application context test passes with local PostgreSQL profile.
- Manual Postman workflow passed for auth, organization, membership permission, project, task, and comment flows.

Deferred improvements:

- Add automated service/integration tests for tenant isolation and role failures.
- Disable or explicitly configure `spring.jpa.open-in-view`.
